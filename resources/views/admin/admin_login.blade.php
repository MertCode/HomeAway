...
<head>
    ...
    <title>HomeAway - Admin Login</title>
    <style type="text/css">
    ...
    <link rel="preconnect"
        href="{{ asset('https://fonts.gstatic.com" crossorigin') }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="#"
                                            class="noble-ui-logo logo-light d-block mb-2">Home<span>Away</span></a>
                                        ...
                                        <form class="forms-sample" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div>
                                                ...
                                                {{-- forgot password --}}
                                                <a href="forgot-password.html" class="d-block mt-3 text-muted">Forgot
                                                    Password?</a>
                                            </div>
