...
<head>
    ...
    <meta name="autho@r" content="NobleUI" />
    <meta name="keywords"
        content="nobleui, bootstrap, bootstrap 5, bootstrap5, admin, dashboard, template, responsive, css, sass, html, theme, front-end, ui kit, web" />

    <title>Admin Panel - HomeAway</title>
    ...
    <link rel="shortcut
        icon" href="{{ asset('../assets/images/favicon.png') }}" />
</head>
        ...
        <div class="page-wrapper">
            ...
            <footer
                ...
                <p class="text-muted mb-1 mb-md-0">
                    Copyright © 2024
                    <a href="https://mertsozen-portfolio.netlify.app/" target="_blank">Mert Sozen</a>.
                </p>
                <p class="text-muted">
                    Handcrafted With
